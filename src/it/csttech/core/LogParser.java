...
public class LogParser
{
    ...
    */
    private static void exmain()
    {
        ...
        {
            System.out.println("  " + message.getStartRow() + ": " + sdf.format(message.getTimestamp()) + " [" + message.getLogLevel() + "] - "
                    + message.getMessage());
        }
    ...
    {
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss,SSS");
        System.out.print(message.getStartRow() + ": " + sdf.format(message.getTimestamp()) + " [" + message.getLogLevel() + "] - "
